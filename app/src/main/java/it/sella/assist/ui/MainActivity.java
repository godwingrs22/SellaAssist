...
import it.sella.assist.sync.SellaAssistSyncAdapter;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferenceManager.putCache(Utility.USER_GBS_ID_KEY, user.getGbsID(), getApplicationContext());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Log.v(TAG, "<--------Clearing all user data------>");
            SharedPreferenceManager.clearCache(this);
            getContentResolver().delete(SellaAssistContract.UserEntry.CONTENT_URI, null, null);
            getContentResolver().delete(SellaAssistContract.FeedEntry.CONTENT_URI, null, null);
            getContentResolver().delete(SellaAssistContract.EventEntry.CONTENT_URI, null, null);
            getContentResolver().delete(SellaAssistContract.BiometricEntry.CONTENT_URI, null, null);
            getContentResolver().delete(SellaAssistContract.BiometricInfoEntry.CONTENT_URI, null, null);
            finish();
