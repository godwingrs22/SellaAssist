...
public class SellaAssistContract {
    ...
    public static final String CONTENT_AUTHORITY = "it.sella.assist.provider";
    ...
    public static class UserEntry implements BaseColumns {
        ...
        public static Uri buildUserByGbsId(String gbsId) {
            return CONTENT_URI.buildUpon().appendPath(gbsId).build();
        }

        public static String getGbsIdFromUserUri(Uri uri) {
    ...
    public static class BiometricEntry implements BaseColumns {
        ...
        public static Uri buildBiometricByDate(String date) {
            return CONTENT_URI.buildUpon().appendPath(date).build();
        }

        public static String getBiometricDateFromUri(Uri uri) {
            return uri.getPathSegments().get(1);
        }
    }
    ...
    public static class BiometricInfoEntry implements BaseColumns {
        ...
        public static Uri buildBiometricInfoByTimestamp(long timestamp) {
            return CONTENT_URI.buildUpon().appendPath(Long.toString(timestamp)).build();
        }

        public static long getBiometricInfoByTimestampFromUri(Uri uri) {
            return Long.parseLong(uri.getPathSegments().get(1));
        }
    }
    ...
    public static class EventEntry implements BaseColumns {
        ...
        public static Uri buildEventById(long eventId) {
