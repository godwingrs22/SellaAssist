...
public class Utility {
    ...
    public static String getFeedTimeStamp(String timestamp) {
        return (String) DateUtils.getRelativeTimeSpanString(Long.parseLong(timestamp), System.currentTimeMillis(), DateUtils.SECOND_IN_MILLIS);
    }
